...
function App() {
  ...
  return <div className="app">
    ...
    {screen === 'setup' && <main className="setup page">
      ...
      <section className="panel compact"><h3><span>4</span> Rodadas</h3><div className="round-options">{[5, 10, 15, 20, 25, 30].map(n => <button className={roundCount === n ? 'active' : ''} onClick={() => setRoundCount(n)} key={n}>{n}</button>)}</div></section>
