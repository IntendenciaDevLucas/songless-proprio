...
export type GameEvent =
  ...
  | { type: 'playback'; action: 'play'; uri: string; positionMs: number }
  ...
  | { type: 'result'; player: number; kind: 'song' | 'artist' | 'wrong'; points: number; scores: number[]; song?: string; artist?: string }
  | { type: 'room_closed' }
